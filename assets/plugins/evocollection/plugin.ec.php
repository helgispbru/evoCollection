...
if (isset($_SESSION['mgrValidated'])) {
    ...
    require_once MODX_BASE_PATH . "assets/plugins/evocollection/functions.php";
}
...
switch ($modx->event->name) {
    case 'OnPageNotFound':
        require_once MODX_BASE_PATH . "assets/plugins/evocollection/actions.php";
        break;

    case 'OnDocFormRender':
        require_once MODX_BASE_PATH . "assets/plugins/evocollection/table.php";
        break;

    case 'OnManagerNodePrerender':
        require_once MODX_BASE_PATH . "assets/plugins/evocollection/tree.php";
        break;
}
