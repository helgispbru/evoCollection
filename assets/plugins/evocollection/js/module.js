$(document).ready(function () {
    $('#table_rows').on('keyup', '#last_str td', function () {
        ...
        $('#table_rows').append(`<tr id="last_str">
            <td valign="top">
                <input type="text" maxlength="255" name="title_row[]" value="" class="inputBox" />
            </td>
            <td>
                <div>
                ...
                <small>выбрать из:
                <a href="#" class="set_doc" style="margin-left:5px;">документа</a>
                <a href="#" class="set_tv" style="margin-left:5px;">ТВ-параметров</a>
                <a href="#" class="cancel" style="margin-left:5px;">отменть</a>
                </small>
            </td>
            <td valign="top">
                <select class="inputBox" name="type_row[]">${optSelect}</select>
            </td>
            <td valign="top">
                <input type="text" maxlength="255" name="width_row[]" value="" class="inputBox" >
            </td>
            <td valign="top">
                <input type="text" maxlength="255" name="width_row[]" value="" class="inputBox" />
            </td>
    ...
    $('#table_rows').on('click', 'a', function (event) {
        ...
        if ($(this).hasClass('cancel')) {
            $(this).parent().prev().html('<input type="text" maxlength="255" name="value_row[]" value="" class="inputBox" />');
        }
